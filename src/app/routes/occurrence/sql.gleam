...
/// defined in `./src/app/routes/occurrence/sql/get_occurences_by_applicant.sql`.
///
...
/// A row you get from running the `get_recent_occurrences` query
/// defined in `./src/app/routes/occurrence/sql/get_recent_occurrences.sql`.
///
/// > 🐿️ This type definition was generated automatically using v4.4.1 of the
/// > [squirrel package](https://github.com/giacomocavalieri/squirrel).
///
pub type GetRecentOccurrencesRow {
  GetRecentOccurrencesRow(
    id: Uuid,
    created_at: Option(Timestamp),
    description: Option(String),
    category: Option(String),
...
/// > the [squirrel package](https://github.com/giacomocavalieri/squirrel).
///
pub fn get_recent_occurrences(
  db: pog.Connection,
) -> Result(pog.Returned(GetRecentOccurrencesRow), pog.QueryError) {
  let decoder = {
    use id <- decode.field(0, uuid_decoder())
    ...
    decode.success(GetRecentOccurrencesRow(
      id:,
      created_at:,
      description:,
      category:,
